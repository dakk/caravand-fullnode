...
(* OASIS_START *)
(* DO NOT EDIT (digest: 79b4555cc2fa1cc29b957462af8f3348) *)
(*
...
let setup_t =
  {
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "network"];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "ocamlbuild"
                        ];
                      bs_c_sources = [];
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "\151Y\139\197X\153\246\240(k\020\025g\155\179\153";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
