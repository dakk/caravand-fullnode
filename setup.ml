...
(* OASIS_START *)
(* DO NOT EDIT (digest: fec7c3030ead239de2d8d711512a73e7) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis = "bitcoin node, functional and type-safe";
          description = None;
          categories = [];
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Log"; "Crypto"; "Config"; "Params"];
                      lib_pack = false;
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Tx"; "Block"; "Blockchain"; "Lighting"; "Script"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Dns"; "Network"; "Message"; "Peer"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for simplelib";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "letchain.ml"})
            ];
          plugins =
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "6\246\182\203Wa\212q8\172\0027\021\172\006\003";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
