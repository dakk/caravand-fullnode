...
(* OASIS_START *)
(* DO NOT EDIT (digest: 68eccecfa59558c5d3f2a1ca5470acc6) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Dns"; "Network"; "Params"; "Message"; "Peer"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "\235s\007\192\155\138\133\192IJU!\188p\253\129";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
